  ...
  const handleSearch = (suggestion) => {
    ...
    switch (suggestion.type) {
      case 'service':
        ...
        if (currentCity) {
          navigate(`/${formatUrlSegment(suggestion.value)}/${formatUrlSegment(currentCity)}`);
        } else {
          navigate(`/${formatUrlSegment(suggestion.value)}`);
        }
        break;
      case 'city':
        ...
        if (currentCategory) {
          navigate(`/${formatUrlSegment(currentCategory)}/${formatUrlSegment(suggestion.value)}`);
        } else {
          navigate(`/all/${formatUrlSegment(suggestion.value)}`);
        }
        break;
      case 'business':
      ...
      default:
        if (query.trim()) {
          ...
          if (currentCity) {
            navigate(`/search/${searchQuery}/${formatUrlSegment(currentCity)}`);
          } else {
